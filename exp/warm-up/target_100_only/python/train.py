...
def train():
    ...
    for step in trange(args.early_stop):
        ...
        if (step + 1) % args.log_interval == 0:
            ...
            print('iter:{}/{} lr:{:.6f} ce_loss:{:.6f} total_loss:{:.6f}'.format(step + 1, args.train_iterations, lr, ce_loss.item(), total_loss.item()))
            logger.info('iter:{}/{} lr:{:.6f} ce_loss:{:.6f} total_loss:{:.6f}'.format(step + 1, args.train_iterations, lr, ce_loss.item(), total_loss.item()))
